// Miroir de apps/web/src/lib/icones-stock.ts (lui-même miroir de
// apps/api/src/stocks/icones-stock.constants.ts) — liste fermée d'icônes
// proposées pour un article de stock. Le serveur revalide toujours cette
// liste. Couleurs pour affichage uniquement.
