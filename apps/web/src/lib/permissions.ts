...
// duplique plutot que partage via @fotall/shared-types : mobile n'a aucun ecran
// de gestion des permissions (Option A retenue, voir spec.md), donc rien a
// partager entre plateformes pour l'instant. users.manage/users.permissions
// sont exclus : jamais configurables, jamais affiches dans ce panneau.
