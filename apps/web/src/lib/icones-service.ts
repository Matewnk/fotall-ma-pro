// Miroir de apps/api/src/services/icones.constants.ts (ICONES_SERVICE) —
// liste fermée d'icônes Material Symbols proposées pour un service. Le
// serveur revalide toujours cette liste : ce fichier ne sert qu'à afficher
// le sélecteur, jamais une autorité. Chaque icône porte sa propre couleur
// (affichage uniquement) pour distinguer les catégories/services au coup
// d'œil dans ServicesPage et le panneau de sélection d'OrdersPage.
